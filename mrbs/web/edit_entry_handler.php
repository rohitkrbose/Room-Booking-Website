...
if ($result['valid_booking'])
{
  ...
  $mail->Host = 'dummy.dummy.com';  // Specify main and backup SMTP servers
  ...
  $booker_mail = getUserName() . "@iitk.ac.in";

  $mail->setFrom('dummy@dummy.com', 'IME Department, IIT Kanpur');
  $mail->addAddress($booker_mail, 'Booker');     // Add a recipient

  $mail->isHTML(true);                                  // Set email format to HTML

  $mail->Subject = 'Room Booking Confirmed';
  $mail->Body    = 'The requested room has been booked.';
  $mail->AltBody = 'The requested room has been booked.';
