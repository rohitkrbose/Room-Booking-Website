...
$mrbs_company = "IME Department, IIT Kanpur";   // This line must always be uncommented ($mrbs_company is used in various places)

// Uncomment this next line to use a logo instead of text for your organisation in the header
//$mrbs_company_logo = "icons/iitk.png";    // name of your logo file.   This example assumes it is in the MRBS directory
